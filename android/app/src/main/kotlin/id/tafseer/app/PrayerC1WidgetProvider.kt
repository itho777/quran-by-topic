...
class PrayerC1WidgetProvider : AppWidgetProvider() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        try {
            ...
            val componentName = ComponentName(context, PrayerC1WidgetProvider::class.java)
            val appWidgetIds = appWidgetManager.getAppWidgetIds(componentName)
            if (appWidgetIds != null && appWidgetIds.isNotEmpty()) {
                onUpdate(context, appWidgetManager, appWidgetIds)
            }
        } catch (e: Exception) {
            Log.e("PrayerC1WidgetProvider", "Error in onReceive: ${e.message}", e)
        }
    }
    ...
    override fun onUpdate(
        ...
        try {
            ...
            Log.e("PrayerC1WidgetProvider", "Error updating widget: ${e.message}", e)
        }
    }
}
